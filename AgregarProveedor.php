	...
	<body>
		...
		<div id='ima'>
			...
			<?php include 'Extra/Menus.php'; ?>
				<section id='algo'>
					<form method='post' action='ValidarProveedor.php'>
						<table width="100%" cellspacing="10">
							<caption>Registro de Proveedores</caption>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input type='text' id='ape' name='apel' placeholder='Ingrese Apellido' size="20" maxlength="15" required>
								</td>
								<td>
                            ...
                            <tr>
                                ...
                                <td>
                                	<input type='text' id='tel' name="tele" placeholder='Ingrese Numero' size="20" maxlength='7' required>
                                </td>
                            </tr>
							<tr>
								<td>
