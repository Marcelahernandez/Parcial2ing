<?php 
	...
	if($respuesta2)
	{
	echo"<script>alert('Se a Registrado satisfactoriamente.');window.location.href=\"AgregarProducto1.php\"</script>"; 
	}
	 
	}
	else if($resultado==1)
	{
		echo"<script>alert('Este Producto ya esta registrado.');window.location.href=\"AgregarProducto1.php\"</script>"; 
	}
