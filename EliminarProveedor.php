	...
	<body>
		...
		<div id='ima'>
            ...
            <?
			 ...
			 $consulta= "select Id_Proveedor,Nombre_Proveedor from proveedor order by Nombre_Proveedor asc";
			 $result= mysql_query($consulta);
			?>
				<section id='algo'>
					<form method='post' action='ValidarEliminarProveedor.php'>
						<table width="500px" cellspacing="10">
							<caption>Eliminar Proveedor</caption>
							<tr>
								<td>Seleccione el proveedor a eliminar :</td>
								<td>
